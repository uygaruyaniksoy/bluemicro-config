...
KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_UP  ,KC_NO  , KC_NO,
KC_NO,  KC_NO  ,L_FN,  KC_LEFT,KC_DOWN,KC_RGHT,KC_NO
    )};
...
KC_MUTE,KC_VOLD,KC_VOLU,KC_MPRV,KC_MPLY,KC_MNXT,KC_PAUSE,
KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_MSTP,
KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,
